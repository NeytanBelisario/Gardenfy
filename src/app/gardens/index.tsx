...
export default function GardensRoute() {
  ...
  return (
    <View style={styles.screen}>
        ...
        {hasGardens ? (
          ...
          <View style={styles.emptyState}>
            ...
            <View style={styles.emptyStateCopy}>
              <Text style={styles.emptyStateTitle}>Ainda nao ha jardins cadastrados</Text>
            ...
            <Pressable
              ...
              onPress={() => router.push('/gardens/new' as never)}
            >
      ...
      {hasGardens ? (
        <Pressable style={styles.fab} onPress={() => router.push('/gardens/new' as never)}>
